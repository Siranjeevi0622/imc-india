...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50  w-full" style={{ backgroundColor: '#2F5E8F', borderColor: '#1F2933' }}>
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto flex justify-between items-center h-14 sm:h-16">
