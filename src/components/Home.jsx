  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: '#F3F4F6' }}>
      ...
      <section className="relative w-full" style={{ minHeight: 'clamp(320px, 55vw, 600px)' }}>
        ...
        {/* Content */}
        <div className="relative h-full flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-32">
          <div className="text-center max-w-4xl w-full" data-aos="fade-up">
            <h1 className="font-black text-white mb-4 sm:mb-6 tracking-tight drop-shadow-lg leading-tight"
              style={{ fontSize: 'clamp(2rem, 6vw, 4.5rem)' }}>
              PRECISION IN EVERY<br />
              <span style={{ color: '#7FB7B1' }}>MEASUREMENT</span>
            </h1>
            <p className="text-gray-200 font-light mb-8 sm:mb-10 drop-shadow-md leading-relaxed"
            ...
            <div className="flex flex-col xs:flex-row gap-3 sm:gap-4 justify-center items-center">
              <Link
                to="/calibration"
                className="w-full xs:w-auto px-6 sm:px-8 py-3 text-white font-bold rounded-sm hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 inline-flex items-center justify-center gap-2 text-sm sm:text-base"
              ...
              <Link
                to="/contact"
                className="w-full xs:w-auto px-6 sm:px-8 py-3 border-2 text-white font-bold rounded-sm transition-all duration-300 shadow-lg hover:shadow-xl text-sm sm:text-base text-center"
      ...
      <section
        className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 border-b-2"
        style={{ backgroundColor: 'white', borderColor: '#E5E7EB' }}
      >
        <div className="max-w-7xl mx-auto">
          <h1
            className="font-black mb-10 sm:mb-16 tracking-tight leading-tight"
            data-aos="fade-down"
            style={{ color: '#1F2933', fontSize: 'clamp(2.2rem, 6vw, 4.5rem)' }}
          >
            INDUSTRIAL<br />
          ...
          <div className="grid sm:grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-center">
            {/* Image */}
            <div data-aos="fade-right" className="lg:col-span-1">
              <div className="overflow-hidden rounded-lg shadow-lg">
                <img
                  ...
                  style={{ height: 'clamp(220px, 40vw, 384px)' }}
                />
              </div>
            </div>

            {/* Text */}
            <div data-aos="fade-left" className="lg:col-span-2 space-y-6 sm:space-y-8">
              <p
                className="leading-relaxed text-justify font-light"
                style={{ color: '#3F78A8', fontSize: 'clamp(1rem, 2vw, 1.25rem)' }}
              >
                <span
                  className="font-bold block mb-3 sm:mb-4"
                  style={{ color: '#1F2933', fontSize: 'clamp(1.1rem, 2.5vw, 1.5rem)' }}
                >
              ...
              <Link
                to="/about"
                className="inline-flex items-center gap-3 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-sm transition-opacity duration-300 font-bold tracking-wide hover:opacity-90 text-sm sm:text-base"
                style={{ backgroundColor: '#2F5E8F' }}
              >
                LEARN MORE
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <p
            className="font-semibold mb-10 sm:mb-16"
            data-aos="fade-up"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
              ...
              <div className="flex flex-wrap gap-2 lg:hidden mb-2">
                {sectors.map((sector, index) => {
                  ...
                  return (
                    <div
                      key={sector.name}
                      className="flex items-center gap-2 px-3 py-2 rounded-sm text-sm font-semibold"
                      style={{ backgroundColor: 'white', color: '#3F78A8', border: '1.5px solid #2F5E8F' }}
                      data-aos="fade-up"
                      data-aos-delay={index * 60}
                    >
                      <IconComponent className="w-4 h-4" style={{ color: '#2F5E8F' }} />
                      {sector.name}
                    </div>
                  );
                })}
            ...
            <div data-aos="fade-left" className="lg:col-span-2">
              <h3
                className="font-black mb-6 sm:mb-8 tracking-tight leading-tight"
                style={{ color: '#1F2933', fontSize: 'clamp(1.3rem, 3vw, 1.75rem)' }}
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                {calibrationServices.map((service, index) => (
                  <Link
                    to={service.link}
                    key={service.title}
                    className="group rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 p-5 sm:p-6 border-l-4 block"
